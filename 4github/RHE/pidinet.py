...
def pidinet_tiny_converted():
    config = 'carv4'
    dil1 = True
    sa = True
    pdcs = config_model_converted(config)
    dil = 8 if dil1 else None
    return PiDiNet(20, pdcs, dil=dil, sa=sa, convert=True)

def pidinet_small_converted():
    config = 'carv4'
    dil1 = True
    sa = True
    pdcs = config_model_converted(config)
    dil = 12 if dil1 else None
    return PiDiNet(30, pdcs, dil=dil, sa=sa, convert=True)
